        ...
        <el-row>
            ...
            <el-col :span="19" :offset="1">
                ...
                <el-table :data="list" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
                    ...
                    <el-table-column prop="cover" label="报修图片">
        ...
        <el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
            <el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
                <el-form-item label="回复建议" prop="rcontent">
                    ...
                    <el-button @click="editForm.rcontent = '已经处理。'" style="margin-top: 10px;">填入默认内容</el-button>
                </el-form-item>
            </el-form>
...
export default {
  data() {
    return {
      ...
      editLoading: false,
      editFormRules: {
        rcontent: [{ required: true, message: "请输入回复内容", trigger: "blur" }]
      },
      //编辑界面数据
      editForm: {
        id: 0,
