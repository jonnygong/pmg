        ...
        <el-row>
            ...
            <el-col :span="19" :offset="1">
                ...
                <el-table :data="list" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
                    ...
                    <!--</el-table-column>-->
                    <el-table-column prop="name" label="咨询人名" width="100">
                    </el-table-column>
                    <el-table-column prop="tel" label="咨询人电话" width="130">
                    </el-table-column>
                    <el-table-column prop="rname" label="咨询车位" width="100">
                    </el-table-column>
